...
class AppRoutes {
  ...
  static final routes = [
    ...
    GetPage(name: productInvoice, page: () => const ProductInvoiceScreen(category: 'Productos',)),
    GetPage(name: serviceInvoice, page: () => const ProductInvoiceScreen(category: 'Servicios',)),
    ...
    GetPage(name: productList, page: () => const ProductListScreen(category: 'Productos')),
    GetPage(name: serviceList, page: () => const ProductListScreen(category: 'Servicios')),
